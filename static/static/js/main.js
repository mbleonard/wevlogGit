...
******************************************************************/
	...
	// turn off youtube control buttons when player is not present
	var iframe = document.getElementById("tubular-container");

	if (!iframe) {
		$('#yt-control').css('display','none');
	} else {
		$('#yt-control').fadeOut();
		setTimeout(function() {
			$('#yt-control').css('visibility','visible');
			$('#yt-control').fadeIn();
		}, 3500);
	}

	// youtube player volume buttons
	$('.tubular-mute').click(function () {
		var mute = player.isMuted();
		if (!mute){
			$('.tubular-mute').removeClass('fa-volume-up').addClass('fa-volume-off');
		}
	});
	...
	$('.tubular-mute').click(function () {
		var mute = player.isMuted();
		if (mute){
			$('.tubular-mute').removeClass('fa-volume-off').addClass('fa-volume-up');
		}
	});

	// youtube player playback buttons
	$('.tubular-pause').click(function () {
		$(this).css('display','none');
		$('.tubular-play').css('display','inline');
	});

	$('.tubular-play').click(function () {
		$(this).css('display','none');
		$('.tubular-pause').css('display','inline');
	});
